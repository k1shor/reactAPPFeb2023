...
const UpdateProduct = () => {
    ...
    const { product_name, product_price, product_description, count_in_stock, error, success, product_image, formdata } = product
                        ...
                        <div className='row'>
                            ...
                            <div className='col-6'>
                                <form className='p-5'>
                                    ...
                                    <button className='btn btn-warning w-100' onClick={handleSubmit}>Update Product</button>
                                </form>
                            </div>
                        </div>
